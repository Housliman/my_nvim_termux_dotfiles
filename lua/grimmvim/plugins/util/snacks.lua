...
`7MN.   `7MF'                                 db                      
  MMN.    M           ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣴⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ 
  M YMb   M   .gP"Ya   ,pW"Wq.  `7M'   `MF'` 7MM⠀⠀⠀⠀⣿⣿MMMb.pMMMb.     
  M  `MN. M  ,M'   Yb 6W'   `Wb   VA   ,V     MM⠀⠀⠀⠀⣿⣿⡀  MM    MM     
  M   `MM.M  8M"""""" 8M     M8    VA ,V      MM⠀⠀⠀⢰⣿⣿⠇  MM    MM     
  M     YMM  YM.    , YA.   ,A9     VVV  ⢀⠀   MM  ⠀⣼⣿⡟   MM    MM  ,, 
.JML.    YM   `Mbmmd'  `Ybmd9' ⠀⠀⠀⢀⣤⣤⣶⣶⣶⣶⣶⣶⣤⣤⣄ML..⣴⣿⡿L  JMML  JMML.db 
   ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣶⡇⠀⠀⠀⠀⠀⠀⢀⣠⣶⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⣦⣰⣾⣿⠟⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ 
  ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠬⠟⠀⠀⠀⠀⠀⠀⣋⣤⣥⣾⠟⠁⣠⢹⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣧⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ 
  ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⢀⡄⠀⣀⣀⣀⡀⢾⣿⣿⣿⢡⡾⠠⡏⣼⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣿⣷⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ 
  ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠒⠀⠀⠈⠁⠀⠙⣿⡟⣿⣶⣿⣿⣿⣿⣷⣶⣤⣾⣿⣿⣿⡿⢹⡿⠿⠿⣿⣿⣿⣿⣧⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀ 
